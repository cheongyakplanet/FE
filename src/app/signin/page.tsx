  ...
  return (
    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-4'>
      ...
      <FormField
        ...
        render = {({ field }) => (
          <FormItem>
            ...
            <FormDescription className='text-xs'>비밀번호는 특수문자와 숫자를 포함하여 총 8글자 이상입니다.</FormDescription>
            <FormMessage />
          </FormItem>
        )}></FormField>
      ...
      <CardFooter className='flex justify-end text-sm'>
        계정이 없으신가요?&nbsp;
        <Link href="/signup" className='text-sm underline'>회원가입하러 가기</Link></CardFooter>
    </Card>
    </div>
  )
}
