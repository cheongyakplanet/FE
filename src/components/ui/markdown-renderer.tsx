    ...
    >
      <ReactMarkdown
        ...
        components={{
          ...
          h2: ({ children }) => (
            <h2 className="text-lg font-bold text-gray-900 mt-5 mb-3">{children}</h2>
          ),
          h3: ({ children }) => (
            <h3 className="text-base font-bold text-gray-900 mt-4 mb-2">{children}</h3>
          ),
          p: ({ children }) => (
          ...
          code: ({ inline, children }) => {
            ...
            return (
              <code className="block bg-gray-100 p-4 rounded-md overflow-x-auto text-sm font-mono">
                {children}
              </code>
            );
          },
